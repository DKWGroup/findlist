...
export const ProductCodeManager: React.FC = () => {
  ...
  const loadData = async () => {
    try {
      const categoriesData = await productCodeService.loadCategories();
  ...
  const filteredCodes = productCodes.filter((code) => {
    ...
    const matchesCategory =
      !selectedCategory || code.categoryCode === selectedCategory;
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">
              Zarządzanie kodami produktów
            </h1>
            <p className="text-gray-600">
              System unikalnych kodów i aliasów URL
            </p>
          </div>
        </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">
                  {Object.keys(stats.codesByCategory).length}
                </p>
              </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">
                  {Object.keys(stats.codesByType).length}
                </p>
              </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setNewCodeForm((prev) => ({ ...prev, typeId: e.target.value }))
              }
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ...
        <div className="text-sm text-gray-600">
          <p>
            <strong>Format kodu:</strong> KK-TT-NNN (Kategoria-Typ-Numer)
          </p>
          <p>
            <strong>Przykład:</strong> EL-SH-001 (Elektronika-Smart Home-001)
          </p>
        </div>
      </div>
              ...
              {filteredCodes.map((code) => (
                ...
                >
                  ...
                  <td className="py-4 px-4 font-mono">
                    {code.sequenceNumber.toString().padStart(3, "0")}
                  </td>
