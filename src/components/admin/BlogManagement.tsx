...
export const BlogManagement: React.FC = () => {
  ...
  const handleToggleFeatured = (postId: string) => {
    setPosts(prev => prev.map(p => 
      p.id === postId 
        ? { ...p, isFeatured: !p.isFeatured, updatedAt: new Date().toISOString() }
        : p
    ));
  };
  ...
  const getTypeLabel = (type: string) => {
    switch (type) {
      ...
      case 'collection': return 'Zbiór';
      case 'scam-alert': return 'Scam Alert';
      default: return type;
    }
  };
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'scam-alert': return 'bg-red-100 text-red-800';
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Zarządzanie blogiem</h1>
        ...
        <div className="p-6">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-3 px-4 font-semibold text-gray-900">Wpis</th>
                      ...
                      <td className="py-4 px-4">
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            title={post.isFeatured ? 'Usuń wyróżnienie' : 'Wyróżnij'}
                          >
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Brak wpisów</h3>
