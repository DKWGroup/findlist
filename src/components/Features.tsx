...
import { TrendingUp, Search, Heart, Star, Shield, Zap, Globe, Users, Award, CheckCircle } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Śledzimy TikTok, Instagram i inne platformy, aby znaleźć produkty zanim staną się popularne.',
      color: 'bg-red-100 text-red-600'
    },
    {
      icon: Shield,
      title: 'Zweryfikowane Produkty',
      description: 'Każdy produkt jest sprawdzany pod kątem jakości i wiarygodności sprzedawcy.',
      color: 'bg-green-100 text-green-600'
    },
    {
      icon: Search,
      title: 'Inteligentne Wyszukiwanie',
      description: 'Zaawansowane filtry i wyszukiwarka semantyczna pomagają znaleźć dokładnie to, czego szukasz.',
      color: 'bg-blue-100 text-blue-600'
    },
    {
      icon: Star,
      title: 'Szczere Recenzje',
      description: 'Sprawdź opinie innych użytkowników i podziel się swoimi doświadczeniami z produktami.',
      color: 'bg-yellow-100 text-yellow-600'
    },
    {
      icon: Globe,
      title: 'Najlepsze Ceny',
      description: 'Porównujemy ceny z Temu, AliExpress, Amazon i innych sklepów online.',
      color: 'bg-indigo-100 text-indigo-600'
    },
    {
      icon: Heart,
      title: 'Wishlisty i Ulubione',
      description: 'Zapisuj produkty na później i twórz własne kolekcje ulubionych przedmiotów.',
      color: 'bg-pink-100 text-pink-600'
    },
    {
      icon: Zap,
      title: 'Błyskawiczne Aktualizacje',
      description: 'Nowe produkty i trendy pojawiają się na platformie w czasie rzeczywistym.',
      color: 'bg-purple-100 text-purple-600'
    },
    {
      icon: Users,
      title: 'Społeczność',
      description: 'Dołącz do tysięcy użytkowników dzielących się swoimi odkryciami i opiniami.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Nasza platforma łączy w sobie najlepsze funkcje social commerce z inteligentnym wyszukiwaniem produktów
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Nasze algorytmy 24/7 skanują TikToka, Instagrama i inne platformy w poszukiwaniu viralowych produktów.
                </p>
                ...
                <p className="text-gray-600 text-sm">
                  Sprawdzamy opinie, analizujemy materiały promocyjne i weryfikujemy wiarygodność sprzedawców.
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Wybrane produkty testujemy osobiście, aby sprawdzić czy spełniają obietnice z reklam.
                </p>
                ...
                <p className="text-gray-600 text-sm">
                  Tworzymy szczegółowe recenzje z oceną każdego aspektu produktu i rekomendacjami zakupu.
                </p>
              </div>
            </div>
          </div>
