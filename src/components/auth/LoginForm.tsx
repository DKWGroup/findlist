...
export const LoginForm: React.FC = () => {
  const { login, error, isLoading: authLoading, validatePassword } = useAuth();
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                disabled={isFormLoading}
                className={`w-full pl-10 pr-12 py-3 border ${formError && !formData.password ? 'border-red-300 bg-red-50' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all`}
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/reset-hasla" className="text-sm text-blue-600 hover:text-blue-700">
              Nie pamiętasz hasła?
            </Link>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600 mb-2">
            Nie masz konta?{' '}
            <Link to="/rejestracja" className="text-blue-600 hover:text-blue-700 font-medium">
              Zarejestruj się
            </Link>
          </p>
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          ...
          <div className="text-xs text-blue-700">
            ...
            <p>Zarejestruj nowe konto lub użyj istniejących danych logowania.</p>
          </div>
        </div>
      </div>
    </div>
