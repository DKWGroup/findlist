...
import { TrendingUp, Search, Heart, Star, ArrowRight, Sparkles, Users, Award } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Sprawdzamy <span className="text-blue-600">viralowe hity</span> –<br />
            polecamy tylko <span className="text-purple-600">najlepsze produkty</span><br />
            z social mediów!
          </h1>
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed">
            ...
            Przeglądaj zweryfikowane produkty, czytaj szczere recenzje i kupuj przez sprawdzone linki. 
            <strong className="text-gray-800"> Dołącz do społeczności, która wie, co jest na topie!</strong>
          </p>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 max-w-2xl mx-auto border border-gray-100">
            <p className="text-gray-700 mb-4">
              <strong>Dołącz do społeczności</strong> która odkrywa najlepsze viralowe produkty przed wszystkimi!
            </p>
