...
export const MetaTags: React.FC<MetaTagsProps> = ({
  ...
  canonical,
  ogImage = "https://viralist.pl/og-image.jpg",
  ogType = "website",
  structuredData,
  noIndex = false,
  prevPage,
  ...
  const fullDescription = description.length <= 155 ? description : description.substring(0, 152) + "...";
  const currentUrl = canonical || (typeof window !== 'undefined' ? window.location.href : 'https://viralist.pl');
