              ...
              {showTrendingOnly ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-gray-600 text-sm mb-4">
                      Trending produkty to te, które dopiero zaczynają podbijać
                      social media. Kupując je wcześnie, możesz być trendsetter
                      w swoim otoczeniu.
                    </p>
                    ...
                    <p className="text-gray-600 text-sm">
                      Produkty w fazie trending często mają lepsze ceny
                      promocyjne, zanim staną się mainstream i ich ceny wzrosną.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-3">
                    ...
                    <p className="text-gray-600 text-sm mb-4">
                      Monitorujemy TikToka i Instagrama 24/7, aby wyłapać
                      produkty w momencie, gdy zaczynają zyskiwać popularność.
                    </p>
                    ...
                    <p className="text-gray-600 text-sm">
                      Każdy trending produkt przechodzi przez nasz proces
                      weryfikacji jakości i wiarygodności sprzedawcy.
                    </p>
                  </div>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Przeglądaj kompletny katalog viralowych produktów z
                      różnych kategorii. Od gadżetów tech po produkty beauty -
                      znajdziesz tu wszystko, co jest popularne w social
                      mediach.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Każdy produkt ma szczegółowe recenzje od naszej
                      społeczności. Sprawdź opinie innych użytkowników przed
                      zakupem i podejmij świadomą decyzję.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-3">
                    ...
                    <p className="text-gray-600 text-sm">
                      ...
                      najkorzystniejsze opcje zakupu. Oszczędzaj czas i
                      pieniądze dzięki naszym sprawdzonym linkom afiliacyjnym.
                    </p>
                  </div>
                </div>
              )}
