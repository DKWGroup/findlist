      ...
      <Layout>
        ...
        <main>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <label htmlFor="privacy" className="ml-2 block text-sm text-gray-600">
                        Akceptuję <a href="/polityka-prywatnosci" className="text-blue-600 hover:underline">politykę prywatności</a> i wyrażam zgodę na przetwarzanie moich danych osobowych w celu udzielenia odpowiedzi na moje zapytanie.
                      </label>
                    </div>
                ...
                <div>
                  ...
                  <div className="space-y-8">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:kontakt@viralist.pl" className="text-blue-600 hover:underline">kontakt@viralist.pl</a>
                        <p className="text-gray-600 mt-2 mb-1">Współpraca biznesowa:</p>
                        <a href="mailto:biznes@viralist.pl" className="text-blue-600 hover:underline">biznes@viralist.pl</a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mb-1">Obsługa klienta:</p>
                        <a href="tel:+48123456789" className="text-blue-600 hover:underline">+48 123 456 789</a>
                        <p className="text-gray-600 mt-2 mb-1">Godziny pracy:</p>
                  ...
                  {/* Social Media */}
                  <div className="mt-10">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Znajdź nas w social mediach</h3>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="max-w-3xl mx-auto space-y-6">
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600">
                    Staramy się odpowiadać na wszystkie wiadomości w ciągu 24-48 godzin w dni robocze. 
                    W weekendy i święta czas odpowiedzi może być dłuższy.
                  </p>
                </div>

                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Czy mogę zaproponować produkt do dodania na platformę?</h3>
                  <p className="text-gray-600">
                    Oczywiście! Zachęcamy do przesyłania propozycji produktów, które Twoim zdaniem 
                    powinny znaleźć się na VIRALIST. Wystarczy wypełnić formularz kontaktowy, 
                    wybierając temat "Propozycja produktu".
                  </p>
                </div>

                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Jak mogę zgłosić problem techniczny?</h3>
                  <p className="text-gray-600">
                    Problemy techniczne możesz zgłosić poprzez formularz kontaktowy, wybierając 
                    temat "Zgłoszenie problemu". Prosimy o dokładny opis problemu, w tym informacje 
                    o używanej przeglądarce i urządzeniu.
                  </p>
                </div>

                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Czy oferujecie współpracę dla influencerów?</h3>
                  <p className="text-gray-600">
                    Tak, współpracujemy z influencerami, którzy pasują do profilu naszej platformy. 
                    Jeśli jesteś zainteresowany współpracą, napisz do nas na adres biznes@viralist.pl 
                    lub wypełnij formularz kontaktowy, wybierając temat "Propozycja współpracy".
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Nasza lokalizacja</h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Znajdź nas w centrum Warszawy
                </p>
              </div>
              ...
              <div className="bg-gray-200 rounded-xl overflow-hidden h-96">
                ...
                <div className="w-full h-full flex items-center justify-center bg-gray-100">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">Mapa zostanie załadowana po dodaniu klucza API Google Maps</p>
                  </div>
                </div>
              </div>
            </div>
