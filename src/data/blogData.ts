import { BlogCategory, BlogLabel, BlogPost } from "../types/blog";
...
export const blogLabels: BlogLabel[] = [
  {
    id: "warte-pieniedzy",
    name: "Warte pieniędzy",
    color: "bg-green-100 text-green-800",
    type: "positive",
  },
  {
    id: "tylko-dla-fanow",
    name: "Tylko dla fanów",
...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Szczegółowa recenzja viralnej lampy LED z głośnikiem Bluetooth, która podbija TikToka. Sprawdzamy czy rzeczywiście warta jest swojej ceny.",
...
**TikTok:** [Zobacz viral video z tego produktu](https://tiktok.com/@user/video/123)`,
    ...
    notForWho:
      "Ta lampa nie sprawdzi się u osób szukających głównego źródła oświetlenia w pomieszczeniu. Nie polecam również osobom, które preferują minimalistyczne wnętrza.",
    productLinks: {
